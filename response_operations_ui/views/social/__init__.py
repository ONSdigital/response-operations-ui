...
social_bp.add_url_rule('/case/<case_id>/response-status', view_func=change_case_response_status, methods=['GET'])
social_bp.add_url_rule('/case/<case_id>/response-status',
