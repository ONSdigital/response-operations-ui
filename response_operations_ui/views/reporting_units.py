...
def build_respondent_table_data_dict(respondents, ru_ref):
    ...
    for respondent in respondents:
        ...
        for survey_id in respondent_surveys:
            ...
            enrolment_status = party_controller.get_enrolment_status_for_respondent(respondent, ru_ref, survey_id)
            table_data[respondent['id']]['surveys'][survey_data[survey_id]] = enrolment_status

        table_data[respondent['id']]['surveys'] = sorted(
            table_data[respondent['id']]['surveys'].items(), key=lambda t: t[0])
