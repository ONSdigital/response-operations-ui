...
class NotifyController:
    ...
    def _send_message(self, email, template_id, personalisation=None, reference=None):
        ...
        try:
            ...
            logger.error(error=response.text, status_code=response.status_code, ref=ref)
            raise NotifyError('There was a problem sending a notification to Notify-Gateway')
