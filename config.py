...
class Config(object):
    ...
    COLLECTION_EXERCISE_USERNAME = os.getenv('SECURITY_USER_NAME')
    COLLECTION_EXERCISE_PASSWORD = os.getenv('SECURITY_USER_PASSWORD')
    BASIC_AUTH = (COLLECTION_EXERCISE_USERNAME, COLLECTION_EXERCISE_PASSWORD)
...
class DevelopmentConfig(Config):
    ...
    REDIS_DB = os.getenv('REDIS_DB', 0)
    COLLECTION_EXERCISE_USERNAME = os.getenv('SECURITY_USER_NAME', 'admin')
    COLLECTION_EXERCISE_PASSWORD = os.getenv('SECURITY_USER_PASSWORD', 'secret')
    BASIC_AUTH = (COLLECTION_EXERCISE_USERNAME, COLLECTION_EXERCISE_PASSWORD)
