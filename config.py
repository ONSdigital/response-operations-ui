...
class Config(object):
    ...
    SURVEY_SERVICE_USERNAME = os.getenv('SURVEY_SERVICE_USERNAME')
    SURVEY_SERVICE_PASSWORD = os.getenv('SURVEY_SERVICE_PASSWORD')
    SESSION_TYPE = "redis"
...
class DevelopmentConfig(Config):
    ...
    SURVEY_URL = os.getenv('SURVEY_SERVICE_URL', 'http://localhost:8080')
    SURVEY_USERNAME = os.getenv('SURVEY_SERVICE_USERNAME', 'admin')
    SURVEY_PASSWORD = os.getenv('SURVEY_SERVICE_PASSWORD', 'secret')
