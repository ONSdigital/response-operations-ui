...
url_dashboard = (
    "http://localhost:8084/reporting-api/v1/response-dashboard/survey/75b19ea0-69a4-4c58-8d7f-4458c8f43f5c"
    "/collection-exercise/aec41b04-a177-4994-b385-a16136242d05"
)

reporting_json = {
    "metadata": {"timeUpdated": 1592493454.328932, "collectionExerciseId": "aec41b04-a177-4994-b385-a16136242d05"},
    "report": {
        "inProgress": 600,
        "accountsPending": 200,
