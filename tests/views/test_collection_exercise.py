...
class TestCollectionExercise(ViewTestCase):
    ...
    @patch(
        "response_operations_ui.controllers.collection_instrument_controllers.get_cis_and_cir_version"
    )
    def test_view_sample_ci_summary(
        self, get_cis_and_cir_version, get_ce_by_survey, get_survey_by_shortname
    ):
        ...
        get_cis_and_cir_version.return_value = [{"form_type": "0001", "ci_version": "12"}, {"form_type": "0002", "ci_version": None}]
