...
with open(f"{project_root}/test_data/collection_exercise/seft_collection_exercise_details_set_ready_for_live.json") as seft:
...
with open(f"{project_root}/test_data/collection_exercise/seft_collection_exercise_details_execution_started.json") as seft:
...
class TestCollectionExercise(ViewTestCase):
    ...
    @requests_mock.mock()
    @patch("response_operations_ui.views.collection_exercise.build_collection_exercise_details")
    def test_eq_version_change_info(self, mock_request, mock_details):
        data = {"eq-version": "v2"}
        with open(
            f"{project_root}/test_data/collection_exercise/formatted_collection_exercise_details_eq_version.json"
        ) as collection_exercise:
