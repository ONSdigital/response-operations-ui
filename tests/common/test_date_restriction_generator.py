...
class TestDateRestrictionGenerator(unittest.TestCase):
    restriction_texts = {
        ...
        "reminder_email_restriction_text": [
            "Must be after Go Live Tuesday 02 Jun 2020 07:00",
        ...
        "return_by_restriction_text": [
            "Must be after Go Live Tuesday 02 Jun 2020 07:00",
            "Must be before Exercise end Tuesday 30 Jun 2020 07:00",
        ],
        "go_live_restriction_text": [
            "Must be after MPS Monday 01 Jun 2020 07:00",
            "Must be before Return by Tuesday 30 Jun 2020 07:00",
        ],
    ...
    events = {
        "go_live": {"day": "Tuesday", "date": "02 Jun", "time": "2020 07:00"},
        "return_by": {"day": "Tuesday", "date": "30 Jun", "time": "2020 07:00"},
        "exercise_end": {"day": "Tuesday", "date": "30 Jun", "time": "2020 07:00"},
        "mps": {"day": "Monday", "date": "01 Jun", "time": "2020 07:00"},
    }

    def test_nudge_email_0_date_restriction(self):
        self.assertEqual(
            get_date_restriction_text("nudge_email_0", self.events),
            self.restriction_texts["nudge_email_restriction_text"],
        )

    def test_nudge_email_1_date_restriction(self):
        self.assertEqual(
            get_date_restriction_text("nudge_email_1", self.events),
            self.restriction_texts["nudge_email_restriction_text"],
        )

    def test_nudge_email_2_date_restriction(self):
        self.assertEqual(
            get_date_restriction_text("nudge_email_2", self.events),
            self.restriction_texts["nudge_email_restriction_text"],
        )

    def test_nudge_email_3_date_restriction(self):
        self.assertEqual(
            get_date_restriction_text("nudge_email_3", self.events),
            self.restriction_texts["nudge_email_restriction_text"],
        )
