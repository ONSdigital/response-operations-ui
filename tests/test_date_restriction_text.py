...
class TestDateRestrictionGenerator(unittest.TestCase):
    ...
    def test_change_reminder1_with_reminder2(self):
        date_text = get_date_restriction_text('reminder', self.generate_test_ce_events(reminder_one=True,
                                                                                       reminder_two=True,
                                                                                       reminder_three=False))
    ...
    def test_change_reminder2_with_reminder1_and_reminder3(self):
        date_text = get_date_restriction_text('reminder2', self.generate_test_ce_events(reminder_one=True,
                                                                                        reminder_two=False,
                                                                                        reminder_three=True))
    ...
    def test_create_reminder3_with_reminder2(self):
        date_text = get_date_restriction_text('reminder3', self.generate_test_ce_events(reminder_one=False,
                                                                                        reminder_two=True,
                                                                                        reminder_three=False))
